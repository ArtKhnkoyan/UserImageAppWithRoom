package com.khnkoyan.userimagesappwithroom.adapters;
...
import com.khnkoyan.userimagesappwithroom.viewHolders.ImageListHolder;
...
public class ImageListAdapter extends RecyclerView.Adapter<ImageListHolder> {
    ...
    public ImageListAdapter(Context context, List<ImageRoom> imageList) {
