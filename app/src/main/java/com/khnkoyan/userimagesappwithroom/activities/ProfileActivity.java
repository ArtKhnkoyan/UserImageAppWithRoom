...
public class ProfileActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GetUserDataAsyncTaskRoom asyncTaskRoom = new GetUserDataAsyncTaskRoom(this);
        asyncTaskRoom.execute(setEmail);
    }
    ...
    public void getUserDataRoom(UserRoom user) {
                ...
                if (image != null) {
                    try {
                        ...
                        int id = AppDatabase
                                .getInstance(this)
                                .getDao()
                                .selectUserId(setEmail);
                        imageRoom.setBlob(blob);
                        imageRoom.setUserId(id);
                        AppDatabase
                                .getInstance(this)
                                .getDao()
                                .insertImage(imageRoom);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                }
